<meta charset="UTF-8">
    ...
    <link rel="shortcut icon" href="{{asset('images/logo-logos.png')}}" type="image/x-icon">
    <link rel="image_src" href="{{asset('images/logo-logos.png')}}">
    <link href="{{asset('images/logo-logos.png')}}" rel="apple-touch-icon">
